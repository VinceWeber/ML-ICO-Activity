USE [ICO_Activite]
GO
/****** Object:  StoredProcedure [dbo].[Preproc_A1_V6]    Script Date: 11/07/2023 16:32:07 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

/* PROCEDURE CALCULANT LE POIDS PAR ACTE DANS 3 DIMENSIONS :
			DIMENSION 1 : Soins.
			DIMENSION 2 : Soins de support.
			DIMENSION 3 : NC / Hors ICO.
		INPUT PARAMETERS : TABLE ACTE, TABLE UF, TABLE DE SORTIE
		*/
