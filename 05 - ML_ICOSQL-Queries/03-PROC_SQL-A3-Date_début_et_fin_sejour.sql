USE [ICO_Activite]
GO
/****** Object:  StoredProcedure [dbo].[Preproc_A3_V6]    Script Date: 11/07/2023 16:41:22 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[Preproc_A3_V6] @TABLE_ACT nvarchar(50), @TABLE_UF nvarchar(50), @TABLE_SORTIE nvarchar(50), @Seuil as BIGINT
