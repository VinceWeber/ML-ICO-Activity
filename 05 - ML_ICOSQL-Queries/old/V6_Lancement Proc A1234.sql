...
SET @TABLE_SORTIE_B='Tmp_Type_Sejour'
...
EXECUTE [dbo].[Preproc_B1_J0V3V4_Type_Sejour_V6] @TABLE_SORTIE_A , @TABLE_SORTIE_B , @DATE_DEBUT_DATASET, 80,60
...
EXECUTE [dbo].[Preproc_B2_Category_V6] @TABLE_SORTIE_B , 'Tmp_Type_Sej_Table' , 'id_NS' , 'Type_Sejour'
